...
const PowerSupplyUnit2 = ({ motherboards }) => {
  return (
    <div>
      <h1 className="text-3xl p-4">Power Supply Unit Product</h1>
...
PowerSupplyUnit2.getLayout = function getLayout(page) {
  return <RootLayout> {page} </RootLayout>;
};

export default PowerSupplyUnit2;
