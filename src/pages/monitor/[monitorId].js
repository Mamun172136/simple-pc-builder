      ...
      <div>
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside">
            ...
            {motherboard?.keyFeatures?.screenSize && (
              <li>Screen Size: {motherboard?.keyFeatures?.screenSize}</li>
            )}
            {motherboard?.keyFeatures?.resolution && (
              <li>Resolution: {motherboard?.keyFeatures?.resolution}</li>
            )}
            {motherboard?.keyFeatures?.panelType && (
              <li>Panel Type: {motherboard?.keyFeatures?.panelType}</li>
            )}
            {motherboard?.keyFeatures?.refreshRate && (
              <li>Refresh Rate: {motherboard?.keyFeatures?.refreshRate}</li>
            )}
            {motherboard?.keyFeatures?.brightness && (
              <li>Brightness: {motherboard?.keyFeatures?.brightness}</li>
            )}
            {motherboard?.keyFeatures?.responseTime && (
              <li>Response Time: {motherboard?.keyFeatures?.responseTime}</li>
            )}
          </ul>
        </div>
